...
export interface AccountIdentifier {
  id?: string
  account_id?: string
  aref?: string // Account ref: oref/account-name/account-start
}
...
export interface BookIdentifier {
  id?: string
  book_id?: string
  bref?: string // Book ref: oref/book-name/book-start
}
...
export type GenerateAccountCSVFn = (
...
export type GenerateBookSummaryCSVFn = (
  bookEnt: BookEntity,
